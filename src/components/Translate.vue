    ...
    <div  class="exchange">
        ...
        <div class="round-box" v-if="clickFlag">		
				...
				<div style="text-align:center;">
						<b-button  variant="outline-primary" @click="clickWords('Translate this into English:')" v-if="clickFlag">译成英文</b-button>
						<b-button  variant="outline-primary" @click="clickWords('Translate this into Japanese:')" v-if="clickFlag">译成日文</b-button>
						<b-button  variant="outline-primary" @click="clickWords('Translate this into Korean:')" v-if="clickFlag">译成韩语</b-button>
						<b-button  variant="outline-primary" @click="clickWords('Translate this into Chinese:')" v-if="clickFlag">译成中文</b-button>
				</div>
    ...
    methods: {
			async clickWords(target){
			  ...
			  try {
					...
					let prompt = words.length > 500 ? target+'\n\n'+words.substring(0,500) : target+'\n\n'+words
					// console.log(899, "local", prompt) 
					this.axios.request({
							method: 'post',
							url: this.api+'/word',
							data:{
