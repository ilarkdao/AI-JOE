    ...
    <div>
      ...
      <div  class="exchange">
        ...
        <div class="round-box">
					...
					<div class="btn">
						<b-button variant="outline-primary" @click="clickRabbit">生成福兔</b-button>
					</div>
					<div v-if="image_url">
          ...
          <div class="round-box-content-container">
						<b-input
						  ...
						  placeholder="输入内容" v-model="content"
						></b-input>				
          </div>
        </div>
        <!-- 下面的框 -->
        ...
        <!-- 按钮   :disabled="!canTransWyoyoFlag"-->
        <div class="confirm-box">
          <button class="confirm-btn" @click="clickRabbit">
            2222
          </button>
        </div>
