    ...
    <div>
      ...
      <div  class="exchange">
        ...
        <div class="round-box" v-if="clickFlag">
				...
				<b-button  block pill variant="outline-primary" @click="clickPic" v-if="clickFlag">生成图像</b-button>
				
				<div v-if="!clickFlag">
					<div style="margin-top: -2rem;margin-bottom: 1rem;">
						图片关键词句： <span style="font-style: italic;font-size: 0.8rem;">{{prompt}}</span>
					</div>
					<div v-if="image_url">
