  ...
  <div class="container">
    <div  class="exchange">
        ...
        <div class="round-box" v-if="clickFlag">		
				...
				<div style="font-size: 0.8rem;margin-top: 1rem;margin-bottom: 2rem;" v-if="clickFlag">
				注： 可以稍微释放Joe的能力，让它干些更有创意的工作，比如让它写个短篇小说，剧本，策划书，诗歌...... 可能会有惊喜哦！ <br>
				尝试这样输入：<span style="font-style: italic;">以末日小强为主题，创作一篇短篇小说。</span>  <br> 
				或者这样： <span style="font-style: italic;">以岳州窑销售为主题写一份营销策划。</span>
				</div>
