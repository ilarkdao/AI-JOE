    ...
    <div  class="exchange">
        ...
        <div class="round-box" v-if="clickFlag">		
				...
				<div style="text-align:center;">
						<b-button  variant="outline-primary" @click="clickWords('用JavaScript实现以下需求：\n\n')" v-if="clickFlag">JS实现</b-button>
						<b-button  variant="outline-primary" @click="clickWords('用Python实现以下需求：\n\n')" v-if="clickFlag">Python实现</b-button>
						<b-button  variant="outline-primary" @click="clickWords('用Golang实现以下需求：\n\n')" v-if="clickFlag">Golang实现</b-button>
						<b-button  variant="outline-primary" @click="clickWords('用Solidity实现以下需求：\n\n')" v-if="clickFlag">Solidity实现</b-button>
				</div>
    ...
    methods: {
			async clickWords(target){
			  ...
			  try {
					...
					this.isLoading = true
					let prompt = target+this.prompt
					// let prompt = target+'\n /* '+this.prompt+' */'  //js
					// console.log(255, prompt)
					this.axios.request({
							method: 'post',
							url: this.api+'/word',
							data:{
