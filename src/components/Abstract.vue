  ...
  <div class="container">
    <div  class="exchange">
        ...
        <div class="round-box" v-if="clickFlag">		
				...
				<b-button  block pill variant="outline-primary" @click="clickWords" v-if="clickFlag">生成摘要</b-button>
    ...
    methods: {
			async clickWords(){
			  ...
			  try {
					...
					// let prompt = '`'+this.prompt+'`，'+'请将上文生成摘要，以要点形式展现'
					let prompt = words.length > 500 ? words.substring(0,500)+'\n\nTl;dr' : words+'\n\nTl;dr'
					this.axios.request({
							method: 'post',
							url: this.api+'/word',
							data:{
