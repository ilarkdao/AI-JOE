<template>
  <div px-5 pt-5> 
    <div bg-white rounded mt-4.5 pb-6 px-4 lg:px-10 min-h-85vh shadow-sm> 
      <p text-4.5 text-gray-600 text-center pt-2 h-10>图像转文字</p>
      ...
      <div mt-4 mb-2 v-if="infoFlag">识别图片中的文本，以纯文本的形式输出</div>
...
import { NUpload, NPopover, NButton, createDiscreteApi } from "naive-ui"
...
const prompt = ref('识别图片中的文字，调节通顺后后输出')
