<template>
    ...
    <div flex justify-center items-center>
        ...
        <a target="_blank" href="https://x.com/ilark_dao" text-gray-700>
          <img src="~/assets/img/x.png" mr-3 h-4 p-t-1.5 alt="AIJoe" /> 
        </a>
...
<script setup>
import {NButton, NDropdown, createDiscreteApi } from "naive-ui"
